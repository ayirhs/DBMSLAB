--1. The HR department needs a list of departments for departments that do not contain the job
--ID ST_CLERK. Use set operators to create this report.
--2. Create a report that lists the employee ID and job ID of those employees who currently
